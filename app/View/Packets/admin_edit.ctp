                ...
                <div class="col-sm-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <?php echo $this->Form->input('packet_name', array('type' => 'text', 'class' => 'form-control', 'label' => false, 'value' => $packets['Packet']['packet_name']));?>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3 col-xs-12">
                            <?php echo $this->Form->input('day', array('type' => 'text', 'class' => 'form-control', 'label' => false, 'value' => $packets['Packet']['day']));?>
                        </div>
